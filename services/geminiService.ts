...
export const testApiKey = async (
    ...
    try {
        ...
        if (provider === 'mistral') {
            ...
            body = { model: modelName || 'pixtral-12b-2409', messages: [{ role: "user", content: "Test" }], max_tokens: 1 };
        } else { // groq
            endpoint = "https://api.groq.com/openai/v1/chat/completions";
            // Use the selected model from UI, default to llama-3.2-11b-vision-instruct if not provided
            body = { model: modelName || 'meta-llama/llama-4-scout-17b-16e-instruct', messages: [{ role: "user", content: "Test" }], max_tokens: 1 };
        }
