...
const UploadPrompt: FC = () => (
    <div className="col-span-10 flex flex-col items-center justify-center p-5 text-center">
...
export const UploadPanel: React.FC<UploadPanelProps> = (props) => {
  ...
  return (
    <div className="panel-bg p-4 sm:p-6 bg-[#202123] border border-[#363636] rounded-xl shadow-lg">
      ...
      >
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-2 justify-center items-center p-4 min-h-[160px]">
          {stagedFiles.length === 0 ? (
                  ...
                  {showOverflow && (
                      <div className="relative w-full aspect-square rounded-lg overflow-hidden checkered-bg shadow-md flex items-center justify-center text-white font-bold text-lg text-center p-2" title="More files">
                      <img 
